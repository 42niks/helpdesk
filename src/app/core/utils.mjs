...
function doc(title, body) {
  return [
    ...
    "  font-weight: 700;",
    "}",
    "h2 { margin: 0; font-size: 1.0625rem; line-height: 1.35; font-weight: 600; }",
    ...
    ".ticket-row-head h3 { margin: 0; }",
    ".ticket-number-link { font-family: var(--font-data); font-size: 0.8125rem; text-decoration: none; border-bottom: 1px dotted var(--accent); }",
    ".ticket-row-title { margin: 6px 0 2px 0; font-size: 0.9375rem; font-weight: 600; }",
    ".ticket-row-meta { margin: 0; color: var(--text-muted); font-size: 0.8125rem; }",
