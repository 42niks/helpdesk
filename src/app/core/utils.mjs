...
function doc(title, body) {
  return [
    ...
    ".ticket-progress-stop { position: relative; text-align: center; color: var(--text-muted); font-size: 0.72rem; line-height: 1.2; }",
    ...
    ".ticket-progress-dot { display: block; width: 10px; height: 10px; margin: 0 auto 6px; border-radius: 999px; border: 1px solid var(--border-subtle); background: #ffffff; }",
    ...
    ".ticket-progress-stop--current { color: var(--text-primary); font-weight: 700; }",
    ".ticket-progress-stop--current::before { border-top-color: var(--accent); }",
    ".ticket-progress-stop--current .ticket-progress-dot { background: var(--success); border-color: var(--success); box-shadow: 0 0 0 2px #dcfce7; }",
    ".ticket-detail-title { white-space: normal; overflow-wrap: anywhere; }",
    ".detail-stack { display: grid; gap: 10px; margin-top: 0; }",
    ".detail-block h3 { margin: 0 0 6px; font-size: 0.875rem; color: var(--text-muted); }",
    ".detail-block p { margin: 0; font-size: 0.95rem; line-height: 1.45; white-space: pre-wrap; overflow-wrap: anywhere; }",
    ".assigned-tech-card { margin-top: 0; }",
    ".assigned-tech-row { margin: 0; font-size: 0.9375rem; }",
    ".assigned-tech-row + .assigned-tech-row { margin-top: 4px; }",
    ".assigned-tech-row strong { color: var(--text-muted); font-size: 0.8125rem; font-weight: 600; display: inline-block; min-width: 5.5rem; margin-right: 8px; }",
    ".assigned-tech-name-row { display: flex; align-items: center; gap: 8px; }",
    ".assigned-tech-name-row strong { flex: 0 0 auto; }",
    ".assigned-tech-name-value { min-width: 0; overflow-wrap: anywhere; }",
    ...
    ".assigned-tech-assigned-value { min-width: 0; overflow-wrap: anywhere; }",
    ...
    ".assigned-tech-contact-value { min-width: 0; overflow-wrap: anywhere; }",
    ...
    ".timeline-item--event { background: #f8fbfc; border-color: #d5e5ea; }",
    ".timeline-item--event::before { background: #0b7285; border: 1px solid #0b7285; }",
    ".timeline-item--comment { background: #fcfcfd; border-color: #e2e8f0; }",
